...
END_EPOCH = 110000   # < ============= EPOCH number of the model
...
TEST_TRACE_NUM = 4
LOG_FILE_DIR = './test_results/'+ str(int(SERVER_START_UP_TH/MS_IN_S)) + 's'
LOG_FILE = LOG_FILE_DIR + '/static_' + str(int(SERVER_START_UP_TH/MS_IN_S)) + 's'
